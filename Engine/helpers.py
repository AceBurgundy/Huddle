...
ALLOWED_IMAGE_FORMATS: Tuple[str,...] = ('jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'svg', 'webp', 'heic', 'heif', 'ico', 'raw', 'eps', 'pdf', 'psd', 'ai', 'indd', 'tif', 'xcf', 'jxr', 'jp2', 'wdp', 'hdp', 'jng', 'djvu', 'avif', 'jfif', 'exr', 'cr2', 'nef', 'arw', 'rw2', 'orf', 'dng', 'sr2', 'pef', 'dcr', 'erf', 'mrw', 'raf', 'mos', 'x3f', 'srf', '3fr', 'mef', 'pict', 'hdr', 'svgz', 'wmf', 'emf')

def save_picture(location: str, image: str, image_quality: int = 80, as_thumbnail: bool = True) -> str:
    """
    Save a profile picture to a designated folder

    Arguments:
    ----------
        location (str): The static folder path where the image will be saved.
        image (str): The path to the uploaded picture file.
    ...
    image_instance: Image.Image = Image.open(image)

    if as_thumbnail:
        output_size: Tuple[Literal[125], Literal[125]] = (125, 125)
...
class CheckProfanity():
    ...
    def __init__(self, message: Optional[str] = None) -> None:
        """
        Initializes CheckProfanity

        Arguments:
        ----------
            message (Optional[str]): The error message to display when vulgar words are found.
...
def has_illegal_words(text: str, message: Optional[str] = None, enumerate_words: Optional[bool] = False) -> Union[List[str], bool]:
    """
    ...
    ----------
        ...
        message (Optional[str]): The error message to return if illegal words are found.
        enumerate_words (Optional[bool]): Whether to return all illegal words found.
